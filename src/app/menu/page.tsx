...
export default function menu() {
  ...
  return (
    <main>
      <div>
        <hr className="text-center w-72 md:w-96 border-amber-400 border-2 md:mx-[220px] mx-[30px] sm:w-80 sm:mx-[150px] lg:mx-[420px]  xl:mx-[570px] mt-3" />
      ...
      <div className="flex flex-col items-center mt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 w-full px-4">
          <div className="w-80 ml-3 rounded-lg border-8 border-gray-800">
            <Image className="w-80 h-52 cursor-pointer" src={item1} alt="" />
          ...
          <div className="w-80 ml-3 rounded-lg border-8 border-gray-800">
            <Image className="w-80 h-52" src={item13} alt="" />
            <h2 className="text-white text-2xl mt-9 text-center">
              Butter Chicken Steake
            </h2>
          ...
          <div className="w-80 ml-3 rounded-lg border-8 border-gray-800">
            <Image className="w-80 h-52" src={item14} alt="" />
            <h2 className="text-white text-2xl mt-9 text-center">
              Grilled Chicken B.BQ
            </h2>
            <p className="text-white text-center text-2xl">15$</p>
            <p className="text-center text-xl">⭐⭐⭐⭐⭐</p>
          </div>
          <div className="w-80 ml-3 rounded-lg border-8 border-gray-800">
            <Image className="w-80 h-52" src={item15} alt="" />
            <h2 className="text-white text-2xl mt-9 text-center">
      ...
      <div className="flex flex-col items-center mt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 w-full px-4">
          <div className="w-80 ml-3 rounded-lg border-8 border-gray-800">
            <Image className="w-80 h-52" src={item2} alt="" />
            <h2 className="text-white text-2xl  text-center mt-4">
              Grilled Beef Steake
            </h2>
          ...
          <div className="w-80 ml-3 rounded-lg border-8 border-gray-800">
            <Image className="w-80 h-52" src={item16} alt="" />
            <h2 className="text-white text-2xl mt-9 text-center">
          ...
          <div className="w-80 ml-3 rounded-lg border-8 border-gray-800">
            <Image className="w-80 h-52" src={item17} alt="" />
            <h2 className="text-white text-2xl mt-9 text-center">
              Hot & Spicy Steak
            </h2>
          ...
          <div className="w-80 ml-3 rounded-lg border-8 border-gray-800">
            <Image className="w-80 h-52" src={item18} alt="" />
            <h2 className="text-white text-2xl mt-9 text-center">
      ...
      <div className="flex flex-col items-center mt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 w-full px-4">
          <div className="w-80 ml-3 rounded-lg border-8 border-gray-800">
            <Image className="w-80 h-52" src={item5} alt="" />
            <h2 className="text-white text-2xl  text-center mt-4">
              Grilled Smocky Corns
            </h2>
          ...
          <div className="w-80 ml-3 rounded-lg border-8 border-gray-800">
            <Image className="w-80 h-52" src={item6} alt="" />
            <h2 className="text-white text-2xl mt-9 text-center">
          ...
          <div className="w-80 ml-3 rounded-lg border-8 border-gray-800">
            <Image className="w-80 h-52" src={item7} alt="" />
            <h2 className="text-white text-2xl mt-9 text-center">
              Mix Grilled Vegies
            </h2>
          ...
          <div className="w-80 ml-3 rounded-lg border-8 border-gray-800">
            <Image className="w-80 h-52" src={item8} alt="" />
            <h2 className="text-white text-2xl mt-9 text-center">
              Stuffed Grilled Bell Pepper
            </h2>
            <p className="text-white text-center text-2xl">35$</p>
            <p className="text-center text-white text-xl">⭐⭐⭐⭐☆</p>
          </div>
      ...
      <div className="flex flex-col items-center mt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 w-full px-4">
          <div className="w-80 ml-3 rounded-lg border-8 border-gray-800">
            <Image className="w-80 h-52" src={item9} alt="" />
            <h2 className="text-white text-2xl  text-center mt-4">
              Tangy Lemon Mojito
            </h2>
          ...
          <div className="w-80 ml-3 rounded-lg border-8 border-gray-800">
            <Image className="w-80 h-52" src={item10} alt="" />
            <h2 className="text-white text-2xl mt-9 text-center">
              Strawberry Mojito
            </h2>
            <p className="text-white text-center text-2xl">12$</p>
          ...
          <div className="w-80 ml-3 rounded-lg border-8 border-gray-800">
            <Image className="w-80 h-52" src={item11} alt="" />
            <h2 className="text-white text-2xl mt-9 text-center">
              Sweet Melon Mojito
            </h2>
            <p className="text-white text-center text-2xl">10$</p>
          ...
          <div className="w-80 ml-3 rounded-lg border-8 border-gray-800">
            <Image className="w-80 h-52" src={item12} alt="" />
      ...
      <div className="border-6 border-gray-800 ">
        <h1 className="text-white text-center text-3xl">
          So! What are You Waiting For Book Your Table Now
        </h1>
        <br />
